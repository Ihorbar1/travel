...
class Feedback extends React.Component {
   state = {
      ...
      feedbackViewData: [
         {
            name: 'Андрій',
            description: `Починаючи з моменту замовлення туру і до моменту повернення додому, кожен етап нашої подорожі був добре спланований та організований. Ми отримали докладну інформацію про наші готелі, трансфери та розклад наших екскурсій. Крім того, наші питання та запити були швидко та ефективно вирішені менеджерами компанії.

            Ми були вражені високою якістю обслуговування та уважністю до деталей, яку надали нам представники "Чтеі-Тур". Я б без вагань рекомендував їх послуги всім, хто шукає якісний та надійний туроператор. Дякую, "Чтеі-Тур", за чудовий досвід та відпочинок!`,
            id: 1,
         }
      ],
      showModal: false,
