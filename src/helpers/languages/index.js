const ua = {
   ...
   certificateElem4: 'Ліцензія (зразок)',
   certificateElem5: 'Закон України про захист прав споживачів',
   certificateElem6: 'Закон України про туризм',
   certificateElem7: 'Про затвердження Ліцензійних умов провадження туроператорської діяльності',

   //TOURS PAGE
   toursHeader: 'Наші тури',
   tourCompHeader: 'Наші тури',
...
const en = {
   ...
   certificateElem4: 'License (sample)',
   certificateElem5: 'Law of Ukraine on Consumer Protection',
   certificateElem6: 'Law of Ukraine on Tourism',
   certificateElem7: 'About the statement of License conditions of carrying out tour operator activity',

   //TOURS PAGE
   toursHeader: 'Our tours',
   tourCompHeader: 'Our tours',
   //COMP TOURITEM ELEMENTS
...
const ro = {
   ...
   certificateElem4: 'Licență (eșantion)',
   certificateElem5: 'Legea Ucrainei privind protecția consumatorilor',
   certificateElem6: 'Legea Ucrainei privind turismul',
   certificateElem7: 'Despre declarația de Condiții de licență pentru desfășurarea activității de tour operator',

   //TOURS PAGE
   toursHeader: 'Tururile noastre',
   tourCompHeader: 'Tururile noastre',
   //COMP TOURITEM ELEMENTS
   ...
   // FORM
   contactFormHeader: 'Contactează-ne',
   formName: 'Name',
   formPhone: 'Phone',
   formEmail: 'E-mail',
   formQuestion: 'Question',
